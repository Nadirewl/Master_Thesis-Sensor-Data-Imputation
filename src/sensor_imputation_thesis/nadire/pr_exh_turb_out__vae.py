...
##VAE for this column does not work cuz it's fully null... after dropping, it disappears completely
...
# (edit point as needed)
targetcolumn = "pr_exh_turb_out__0"
...
# Define run name
vae_run_name = "vae_pr_exh_turb_out__0"
