...
#Load data (wasn't sure if my parquet file can be read in different users' device, so here is to load again)
#For only training great vae, use this tag list (9 missing cols)
tags = [
        "time",
        "fr_eng",
        "te_exh_cyl_out__0",
  ...
  with mlflow.start_run(run_name=run_name):
        for epoch in range(1, args.epochs + 1):
            ...
            #log mlflow metric
                ...
                mlflow.log_metric("epoch_num:", args[1])
